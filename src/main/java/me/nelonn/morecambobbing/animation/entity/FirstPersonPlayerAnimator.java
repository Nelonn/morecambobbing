...
import me.nelonn.morecambobbing.animation.pose.sample.*;
...
public class FirstPersonPlayerAnimator extends LivingEntityAnimator<LocalPlayer, PlayerModel<LocalPlayer>, FirstPersonPlayerAnimator.FPPlayerLocators>{
    ...
    public static final ResourceLocation ANIMATION_FP_RIGHT_EMPTY_RAISE = TimelineGroupData.getNativeResourceLocation("fp_right_empty_raise");
    public static final ResourceLocation ANIMATION_FP_RIGHT_EMPTY_LOWER = TimelineGroupData.getNativeResourceLocation("fp_right_empty_lower");
    public static final ResourceLocation ANIMATION_FP_RIGHT_EMPTY_IDLE = TimelineGroupData.getNativeResourceLocation("fp_right_empty_idle");
    public static final ResourceLocation ANIMATION_FP_RIGHT_EMPTY_PUNCH = TimelineGroupData.getNativeResourceLocation("fp_right_empty_punch");
    public static final ResourceLocation ANIMATION_FP_RIGHT_EMPTY_WALK = TimelineGroupData.getNativeResourceLocation("fp_right_empty_walk");
    public static final ResourceLocation ANIMATION_FP_RIGHT_EMPTY_JUMP = TimelineGroupData.getNativeResourceLocation("fp_right_empty_jump");
    public static final ResourceLocation ANIMATION_FP_RIGHT_EMPTY_MINE = TimelineGroupData.getNativeResourceLocation("fp_right_empty_mine");
    public static final ResourceLocation ANIMATION_FP_RIGHT_EMPTY_FALLING = TimelineGroupData.getNativeResourceLocation("fp_right_empty_falling");
    public static final ResourceLocation ANIMATION_FP_RIGHT_BASICITEM_POSE = TimelineGroupData.getNativeResourceLocation("fp_right_basicitem_pose");
    ...
    public void tick(LivingEntity livingEntity, AnimationDataContainer entityAnimationData){
        ...
        // Debug
        //MoreCamBobbingMain.LOGGER.info("Current: {} New: {} Condition: {}", getEntityAnimationVariable(MAIN_HAND_ITEM).getItem(), this.livingEntity.getMainHandItem().getItem(), this.compareVariableItemStackWithEntityItemStack(MAIN_HAND_ITEM, this.livingEntity.getMainHandItem()));
        ...
        //MoreCamBobbingMain.LOGGER.info(getEntityAnimationVariable(IS_MINING));

        boolean isInputtingMovement =
                this.livingEntity.input.forwardImpulse != 0 ||
                this.livingEntity.input.leftImpulse != 0;
        //MoreCamBobbingMain.LOGGER.info("{}, {}", this.livingEntity.input.forwardImpulse, this.livingEntity.animationSpeed);
    ...
    public void tickExternal(){
        ...
        AnimationPose<FPPlayerLocators> animationPose = this.calculatePose();
